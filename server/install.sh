...
HIHY_HYSTERIA2_URL="${HIHY_HYSTERIA2_URL:-https://raw.githubusercontent.com/Special-Care/Hi_Hysteria/refs/heads/main/server/hy2.sh}"
HIHY_HYSTERIA1_URL="${HIHY_HYSTERIA1_URL:-https://raw.githubusercontent.com/Special-Care/Hi_Hysteria/refs/heads/main/server/install.sh}"
